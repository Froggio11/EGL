...
async def guide_cmd(i):
    ...
    p1+="Fill-in players who help if a team is short or someone drops out mid-match."
    await i.response.send_message(p1)
    p2="\U0001f4cb **All Commands**\n\n"
    p2+="\u2694\ufe0f **Team**\n"
    p2+="`/team create name:Name` \u2014 Create a team, become captain\n"
    p2+="`/team invite @player` \u2014 Invite someone *(captain only)*\n"
    p2+="`/team roster` \u2014 See your team\n"
    p2+="`/teaminfo name:Name` \u2014 Look up any team\n"
    p2+="`/team leave` \u2014 Leave team *(players only)*\n"
    p2+="`/disband` \u2014 Delete your team *(captain only)*\n"
    p2+="`/captain swap @player` \u2014 Transfer captain role\n\n"
    p2+="\U0001f91d **Free Agent**\n"
    p2+="`/fa register` \u2014 Sign up as a sub\n"
    p2+="`/fa unregister` \u2014 Remove yourself\n"
    p2+="`/fa list` \u2014 See available subs\n"
    p2+="`/fa request` \u2014 Ping FAs to find a sub *(captain only)*\n\n"
    p2+="\U0001f4c5 **Match** *(use inside your match thread)*\n"
    p2+="`/schedule 05 Aug 19:00` \u2014 Set match time *(captain only)*\n"
